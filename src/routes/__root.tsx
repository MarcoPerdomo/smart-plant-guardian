    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This page has wilted. Let's get you back to your garden.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track your indoor plants with Arduino-powered moisture, humidity, and pest sensors. Get AI-powered watering schedules and care summaries." },
      { property: "og:title", content: "Verdant — Smart houseplant care" },
      { property: "og:description", content: "Arduino sensors + AI care advice for every plant in your home." },
