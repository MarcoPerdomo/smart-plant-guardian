...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Verdant — Smart houseplant care with Arduino sensors" },
      { name: "twitter:description", content: "Plug in Arduino sensors, track soil moisture, humidity, light and pests, and get AI care summaries for every plant." },
